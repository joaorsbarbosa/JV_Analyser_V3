...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_rsh = QtWidgets.QLabel(self.figures_of_merit)
        self.label_rsh.setGeometry(QtCore.QRect(15, 110, 91, 18))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.label_rsh.setFont(font)
        self.label_rsh.setObjectName("label_rsh")
        self.result_rsh = QtWidgets.QLineEdit(self.figures_of_merit)
        self.result_rsh.setGeometry(QtCore.QRect(130, 110, 61, 20))
        self.result_rsh.setDragEnabled(True)
        self.result_rsh.setReadOnly(True)
        self.result_rsh.setObjectName("result_rsh")
        ...
        self.label_rsh_rsquared = QtWidgets.QLabel(self.figures_of_merit)
        self.label_rsh_rsquared.setGeometry(QtCore.QRect(200, 110, 21, 18))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.label_rsh_rsquared.setFont(font)
        self.label_rsh_rsquared.setObjectName("label_rsh_rsquared")
        self.result_rsh_squared = QtWidgets.QLineEdit(self.figures_of_merit)
        self.result_rsh_squared.setGeometry(QtCore.QRect(220, 110, 51, 20))
        self.result_rsh_squared.setDragEnabled(True)
        self.result_rsh_squared.setReadOnly(True)
        self.result_rsh_squared.setObjectName("result_rsh_squared")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_rsh.setText(_translate("MainWindow", "R<sub>SH</sub> (kΩ • cm<sup>2</sup>)"))
        self.result_rsh.setPlaceholderText(_translate("MainWindow", "0.00"))
        ...
        self.label_rsh_rsquared.setText(_translate("MainWindow", "R<sup>2</sup>"))
        self.result_rsh_squared.setPlaceholderText(_translate("MainWindow", "0.00"))
