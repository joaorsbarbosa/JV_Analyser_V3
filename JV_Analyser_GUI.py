...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_a1light = QtWidgets.QLineEdit(self.analysis_results_light)
        self.lineEdit_a1light.setGeometry(QtCore.QRect(120, 80, 141, 20))
        ...
        self.lineEdit_a2light = QtWidgets.QLineEdit(self.analysis_results_light)
        self.lineEdit_a2light.setGeometry(QtCore.QRect(120, 110, 141, 20))
        ...
        self.lineEdit_j0light = QtWidgets.QLineEdit(self.analysis_results_light)
        self.lineEdit_j0light.setGeometry(QtCore.QRect(120, 140, 141, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_rshdark.setText(_translate("MainWindow", "<html><head/><body><p>R<span style=\" vertical-align:sub;\">SH</span> (kΩ • cm<span style=\" vertical-align:super;\">2</span>)</p></body></html>"))
        ...
        self.label_gsdark.setText(_translate("MainWindow", "<html><head/><body><p>G<span style=\" vertical-align:sub;\">S</span> (mS/cm<span style=\" vertical-align:super;\">2</span>)</p></body></html>"))
